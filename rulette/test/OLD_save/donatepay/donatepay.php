...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $URL ?>/vendor/plugins/animate/animate.min.css">
    <link rel='stylesheet' type='text/css' href='https://donatepay.ru/assets/skin/default_skin/css/theme.css?v=1528109232'>
    <link rel="stylesheet" type="text/css" href="<?php echo $URL ?>/assets/fonts/zocial/zocial.css">
    <link rel="stylesheet" href="<?php echo $URL ?>/vendor/donate/css/emoji.css"/>
    ...
    <div class="panel mn">
        ...
        <div class="panel-body pn">
            <div class="text-center" id="onLoad">
                <img src="<?php echo $URL ?>/images/logo.png" class="p25" style="max-width: 100%; z-index: 2;">
            </div>
